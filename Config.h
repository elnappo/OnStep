...
#define AXIS1_DRIVER_FS_VHIGH         OFF //    OFF, n, (steps/s.) Velocity for switchover to full step and slow decay mode.  Option,**
#define AXIS1_DRIVER_SC_VHIGH         OFF //    OFF, n, (steps/s.) Velocity for switchover to spreadCycle mode.               Option,**
...
#define AXIS2_DRIVER_FS_VHIGH         OFF //    OFF, n, (steps/s.) Velocity for switchover to full step and slow decay mode.  Option,**
#define AXIS2_DRIVER_SC_VHIGH         OFF //    OFF, n, (steps/s.) Velocity for switchover to spreadCycle mode.               Option,**
